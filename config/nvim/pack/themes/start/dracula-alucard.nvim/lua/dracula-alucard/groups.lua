...
local function setup(configs)
    ...
    return {
        ...
        BufferTabpages = { fg = colors.nontext, bg = colors.menu, bold = true },
        BufferTabpageFill = { fg = colors.nontext, bg = colors.menu },
        BufferCurrentSign = { fg = colors.purple },
        BufferCurrentTarget = { fg = colors.red },
        BufferInactive = { fg = colors.comment, bg = colors.visual, italic = true },
        BufferInactiveIndex = { fg = colors.nontext, bg = colors.menu, italic = true },
        BufferInactiveMod = { fg = colors.yellow, bg = colors.menu, italic = true },
        BufferInactiveSign = { fg = colors.nontext, bg = colors.menu, italic = true },
        BufferInactiveTarget = { fg = colors.red, bg = colors.menu, bold = true },
        ...
        -- mini.statusline
        MiniStatuslineModeNormal = { fg = colors.bright_white, bg = colors.purple, bold = true },
        MiniStatuslineModeInsert = { fg = colors.bright_white, bg = colors.green, bold = true },
        MiniStatuslineModeVisual = { fg = colors.bright_white, bg = colors.pink, bold = true },
        MiniStatuslineModeReplace = { fg = colors.bright_white, bg = colors.yellow, bold = true },
        MiniStatuslineModeCommand = { fg = colors.bright_white, bg = colors.cyan, bold = true },
        MiniStatuslineModeOther = { fg = colors.bright_white, bg = colors.orange, bold = true },
        MiniStatuslineInactive = { fg = colors.fg, bg = colors.visual, bold = true },
        MiniStatuslineDevinfo = { fg = colors.purple, bg = colors.menu },
        MiniStatuslineFilename = { fg = colors.fg, bg = colors.menu },
        ...
        MiniFilesTitleFocused = { fg = colors.purple },
